...
export const MARCAS = [
  ...
  { id: 'binance',   name: 'Binance',         categoria: 'Crypto',        keywords: ['binance', 'binance pay', 'binance earn', 'bnb'], logo: 'https://t3.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=https://binance.com&size=128' },
]

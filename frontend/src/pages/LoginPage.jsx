      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-slate-900/60 border border-slate-800 rounded-2xl p-8 backdrop-blur-sm">
          ...
          <p className="text-slate-400 text-sm text-center mb-8">
            Iniciá sesión para ver los descuentos personalizados según tus bancos y hábitos de compra.
          </p>

          <button
            onClick={handleGoogle}
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 bg-white hover:bg-slate-100 text-slate-800 font-semibold py-3 px-4 rounded-xl transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {/* Google icon */}
        ...
        <p className="text-slate-600 text-xs text-center mt-6">
          Al iniciar sesión aceptás nuestros términos de uso.
          <br />Asociación Hermanos Arena · Argentina
        </p>
      </div>
    </div>
  )
